...
PLANCHES = [
    ...
    ('plan-dust-shoe-semelle',
     chemins.DUST_SHOE_PLANS / '01-semelle.pdf',
     1, "la semelle-collier : dessus, face, perspective"),
    ('plan-dust-shoe-brosse',
     chemins.DUST_SHOE_PLANS / '02-brosse.pdf',
     1, "la brosse : la flasque à aimants et la rainure"),
    ('plan-dust-shoe-adaptateur',
     chemins.DUST_SHOE_PLANS / '03-adaptateur.pdf',
     1, "l'adaptateur : tenon en T, conduit en D, pied à cordon"),
    ('plan-dust-shoe-quai',
     chemins.DUST_SHOE_PLANS / '04-quai.pdf',
     1, "le quai : berceau, languette, les trois vis M6"),
